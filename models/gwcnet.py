...
class GwcNet(nn.Module):
    def __init__(self, maxdisp, use_concat_volume=False,est_uncert=False):
...
def GwcNet_G(d):
    return GwcNet(d, use_concat_volume=False,est_uncert=False)


def GwcNet_GC(d):
    return GwcNet(d, use_concat_volume=True,est_uncert=False)

def GwcNet_GCS(d):
    return GwcNet(d, use_concat_volume=True,est_uncert=True)